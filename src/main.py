...
print(query_by_instance("human", "wiki_id, name, es", "LIMIT 5")) #query 5 humans from the table and get their ids, names, and spanish translations
print('\n\nQuery by Name')
print(query_by_name("La%", 'wiki_id, name, instance_of, de, es, ja', 'LIMIT 4')) # query for names starting in La, getting their id, name, instance, german, spanish and japanese translation (only return 4)