...
test_data = [{"id": instance["id"], "sample_id": instance["sample_id"], "tokens": instance["tokens"], "ner_tags": instance["ner_tags"], "ner_tags_index": instance["ner_tags_index"]} for instance in en_dataset["test"]]


save_to_json(train_data, "en_coNER_train.json")
save_to_json(validation_data, "en_coNER_validation.json")
save_to_json(test_data, "en_coNER_test_full.json")